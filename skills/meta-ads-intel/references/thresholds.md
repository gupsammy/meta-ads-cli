...
- All monetary values in the pipeline's analysis files are already in standard display currency units (e.g., rupees not paisa, dollars not cents). NEVER divide or convert these values.
